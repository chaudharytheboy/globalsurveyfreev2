          ...
          ?>
                    ...
                    <td>
                        <a href="update_products.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-sm"
                            ...
                            <a href="add_products.php?id=<?php echo $row['id'];?>" class="btn btn-primary btn-sm add_delet_edi" style="letter-spacing:1px;font-family:roboto;margin-top:10px;width:55%;">Add</a></br>
                            <a href="delete_products.php?eid=<?php echo $row['id']; ?>" 
                           class="btn btn-primary btn-sm add_delet_edi" onclick="return(confirm('Are You Sure You Want to Delete?'));" style="letter-spacing:1px;font-family:roboto;margin-top:10px;width:55%;">Delete</a></br>
